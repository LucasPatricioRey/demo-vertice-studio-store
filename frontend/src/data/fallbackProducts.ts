...
export const fallbackProducts: Product[] = [
  makeProduct({
    ...
    imageUrl: verticeImages.remeraEssential,
    gallery: [verticeImages.texturaAlgodon, verticeImages.outfitCompleto],
  ...
  makeProduct({
    ...
    imageUrl: verticeImages.hoodieCore,
    gallery: [verticeImages.texturaAlgodon, verticeImages.bannerBasicos],
  ...
  makeProduct({
    ...
    category: "Pantalones",
    price: 68000,
    imageUrl: verticeImages.cargoPant,
    gallery: [verticeImages.outfitCompleto, verticeImages.texturaAlgodon],
  ...
  makeProduct({
    ...
    imageUrl: verticeImages.bomberNomade,
    gallery: [verticeImages.hero, verticeImages.dropLimitado],
  ...
  makeProduct({
    ...
    category: "Accesorios",
    price: 24000,
    imageUrl: verticeImages.accesorios,
    gallery: [verticeImages.packaging],
    tags: ["tote", "accesorio"],
    isFeatured: false,
    isNew: true,
    isDrop: false,
  ...
  makeProduct({
    ...
    price: 22000,
    imageUrl: verticeImages.accesorios,
    gallery: [verticeImages.whatsappFlow],
    tags: ["gorra", "minimal"],
    isFeatured: false,
    isNew: false,
    isDrop: false,
  ...
  makeProduct({
    ...
    price: 32000,
    imageUrl: verticeImages.remeraEssential,
    gallery: [verticeImages.texturaAlgodon, verticeImages.lifestyle],
  ...
  makeProduct({
    ...
    price: 64000,
    imageUrl: verticeImages.hoodieCore,
    gallery: [verticeImages.bannerBasicos],
  ...
  makeProduct({
    ...
    category: "Pantalones",
    price: 72000,
    imageUrl: verticeImages.outfitCompleto,
    gallery: [verticeImages.cargoPant],
    tags: ["wide leg", "twill"],
    isFeatured: true,
    isNew: true,
    isDrop: false,
  ...
  makeProduct({
    ...
    category: "Remeras",
    price: 38000,
    imageUrl: verticeImages.chombaBoxy,
    gallery: [verticeImages.texturaAlgodon],
    tags: ["chomba", "boxy"],
    isFeatured: false,
    isNew: true,
    isDrop: false,
  ...
  makeProduct({
    ...
    category: "Camperas",
    price: 76000,
    imageUrl: verticeImages.overshirt,
    gallery: [verticeImages.lifestyle],
  ...
  makeProduct({
    ...
    category: "Drops",
    price: 36000,
    imageUrl: verticeImages.dropLimitado,
    gallery: [verticeImages.remeraEssential, verticeImages.texturaAlgodon],
    tags: ["drop", "limitada"],
    isFeatured: true,
    isNew: true,
    isDrop: true,
  ...
  makeProduct({
    ...
    category: "Pantalones",
    price: 82000,
    imageUrl: verticeImages.jeanVintage,
    gallery: [verticeImages.outfitCompleto],
    tags: ["jean", "denim"],
    isFeatured: false,
    isNew: true,
    isDrop: false,
